...
function Tutorials() {
    ...
    useEffect(() => {
        http.get('/tutorial').then((res) => {  //retrieves tutorial data from server
                                ...
                                <Card>
                                    ...
                                    <CardContent>
                                        ...
                                        <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}
                                            ...
                                            <AccessTime sx={{ mr: 1 }} />
                                            <Typography>
                                                {dayjs(tutorial.createdAt).format(global.datetimeFormat)} {/*retrieves date format from global.js*/}
                                            </Typography>
                                        </Box>
