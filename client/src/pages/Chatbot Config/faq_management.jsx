...
function Faq_Management() {
    ...
    const handleEditSave = () => {
        setFaqs(faqs.map((faq, idx) =>
            idx === editIndex
                ? { ...faq, question: editQuestion, answer: editAnswer, updated: new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' }) }
                : faq
        ));
    ...
    return (
        ...
        <Box sx={{ ml: -6, mt: -4, mb: -30 }}>
            <Box sx={{ display: "flex", bgcolor: "#181617" }}>
                ...
                {/* Main Content */}
                <Box sx={{ flex: 1, bgcolor: "#f7f8fa", p: 5, minHeight: "100vh", mr:'-48px'}}>
